...
<html>
    ...
    <body>
        <div class="page">
            <form class="edit-form" method="post" action="createBook.php" autocomplete = "off"> 
                ...
                <br>
                Book type: 
                <select name="bookMaterial">
                    <option value="paperback">paperback</option>
                </select>
                <br>
                <br>
                Book price: <input type="number" name="bookPrice" required><br>
                Quantity left in store:<input type="number" name="bookQuantity" required><br>
                Store Location ID:<input type="number" name="storeID" required><br>
